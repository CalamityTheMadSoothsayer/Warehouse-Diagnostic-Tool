...
Runs all queries related to failed MasterStaging transactions.
...
class ScenarioFailedTransactions(tk.Frame):
    ...
    def _build(self):
        ...
        styled_label(
            desc,
            "  •  Transactions have failed to post to SAP or downstream systems\n"
            "  •  MasterStaging records are stuck in a failed state",
        ...
        self._overall_lbl = tk.Label(
            self, text="Click Run All Checks to scan for failed transactions.",
